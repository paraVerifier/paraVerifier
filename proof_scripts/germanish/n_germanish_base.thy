...
(neg (andForm (eqn (IVar (Para (Ident ''cache'') p__Inv1)) (Const exclusive)) (eqn (IVar (Para (Ident ''cache'') p__Inv0)) (Const exclusive))))"

definition inv__2::"nat \<Rightarrow> formula" where [simp]:
"inv__2 p__Inv1 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''cache'') p__Inv1)) (Const exclusive)) (eqn (IVar (Ident ''home_exclusive_granted'')) (Const false))))"

definition inv__3::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__3 p__Inv0 p__Inv1 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''cache'') p__Inv0)) (Const exclusive)) (eqn (IVar (Para (Ident ''home_sharer_list'') p__Inv1)) (Const true))))"
