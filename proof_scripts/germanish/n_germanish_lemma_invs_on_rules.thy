(*  Title:      HOL/Auth/n_germanish_lemma_invs_on_rules.thy
...
theory n_germanish_lemma_invs_on_rules imports n_germanish_lemma_inv__1_on_rules n_germanish_lemma_inv__2_on_rules n_germanish_lemma_inv__3_on_rules
begin
lemma invs_on_rules:
