theory lemma_inv__84_on_rules imports lemma_on_inv__84
begin
lemma lemma_inv__84_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv0. p__Inv0\<le>N\<and>f=inv__84  p__Inv0)"
  ...
  apply (cut_tac b1, auto) done
    moreover {
      ...
      apply (cut_tac b2 d1, metis n_StoreVsinv__84) done
    }

    moreover {
      assume d1: "(\<exists> data. data\<le>N\<and>r=n_Store_Home  data)"
      have "invHoldForRule' s f r (invariants N)"
      apply (cut_tac b2 d1, metis n_Store_HomeVsinv__84) done
    }
