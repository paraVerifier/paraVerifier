theory lemma_inv__160_on_rules imports lemma_on_inv__160
begin
lemma lemma_inv__160_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv0 p__Inv1. p__Inv0\<le>N\<and>p__Inv1\<le>N\<and>p__Inv0~=p__Inv1\<and>f=inv__160  p__Inv0 p__Inv1)"
