theory lemma_inv__140_on_rules imports lemma_on_inv__140
begin
lemma lemma_inv__140_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv0 p__Inv1. p__Inv0\<le>N\<and>p__Inv1\<le>N\<and>p__Inv0~=p__Inv1\<and>f=inv__140  p__Inv0 p__Inv1)"
