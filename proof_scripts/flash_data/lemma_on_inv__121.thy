theory lemma_on_inv__121 imports n_flash_data_cub_base
begin
lemma n_PI_Remote_GetVsinv__121:
assumes a1: "(\<exists> src. src\<le>N\<and>r=n_PI_Remote_Get  src)" and
a2: "(\<exists> p__Inv0. p__Inv0\<le>N\<and>f=inv__121  p__Inv0)"
shows "invHoldForRule' s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain src where a1:"src\<le>N\<and>r=n_PI_Remote_Get  src" apply fastforce done
from a2 obtain p__Inv0 where a2:"p__Inv0\<le>N\<and>f=inv__121  p__Inv0" apply fastforce done
