(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_on_inv__105.thy
...
theory n_flash_nodata_cub_lemma_on_inv__105 imports n_flash_nodata_cub_base
begin
...
from a1 obtain src where a1:"src\<le>N\<and>r=n_NI_Local_Get_Put_Head N src" apply fastforce done
  have "?P3 s"
  apply (cut_tac a1 a2 , simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''HomeHeadPtr'')) (Const true)) (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''HeadVld'')) (Const true))))" in exI, auto) done
