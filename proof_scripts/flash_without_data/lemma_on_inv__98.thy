theory lemma_on_inv__98 imports n_flash_nodata_cub_base
begin
lemma n_NI_Local_Get_Get__part__0Vsinv__98:
assumes a1: "(\<exists> src. src\<le>N\<and>r=n_NI_Local_Get_Get__part__0  src)" and
a2: "(\<exists> p__Inv0. p__Inv0\<le>N\<and>f=inv__98  p__Inv0)"
shows "invHoldForRule' s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain src where a1:"src\<le>N\<and>r=n_NI_Local_Get_Get__part__0  src" apply fastforce done
from a2 obtain p__Inv0 where a2:"p__Inv0\<le>N\<and>f=inv__98  p__Inv0" apply fastforce done
