(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_inv__128_on_rules.thy
...
theory n_flash_nodata_cub_lemma_inv__128_on_rules imports n_flash_nodata_cub_lemma_on_inv__128
begin
section{*All lemmas on causal relation between inv__128*}
lemma lemma_inv__128_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(f=inv__128  )"
