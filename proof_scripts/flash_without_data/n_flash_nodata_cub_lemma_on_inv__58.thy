(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_on_inv__58.thy
...
theory n_flash_nodata_cub_lemma_on_inv__58 imports n_flash_nodata_cub_base
begin
section{*All lemmas on causal relation between inv__58 and some rule r*}
lemma n_PI_Remote_GetVsinv__58:
assumes a1: "(\<exists> src. src\<le>N\<and>r=n_PI_Remote_Get  src)" and
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__58  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain src where a1:"src\<le>N\<and>r=n_PI_Remote_Get  src" apply fastforce done
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__58  p__Inv4" apply fastforce done
