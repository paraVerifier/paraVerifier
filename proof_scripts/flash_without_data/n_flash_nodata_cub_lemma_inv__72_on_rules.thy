(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_inv__72_on_rules.thy
...
theory n_flash_nodata_cub_lemma_inv__72_on_rules imports n_flash_nodata_cub_lemma_on_inv__72
begin
section{*All lemmas on causal relation between inv__72*}
lemma lemma_inv__72_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__72  p__Inv4)"
