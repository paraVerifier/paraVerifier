(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_inv__111_on_rules.thy
...
theory n_flash_nodata_cub_lemma_inv__111_on_rules imports n_flash_nodata_cub_lemma_on_inv__111
begin
section{*All lemmas on causal relation between inv__111*}
lemma lemma_inv__111_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv3 p__Inv4. p__Inv3\<le>N\<and>p__Inv4\<le>N\<and>p__Inv3~=p__Inv4\<and>f=inv__111  p__Inv3 p__Inv4)"
