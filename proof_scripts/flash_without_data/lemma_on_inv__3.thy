theory lemma_on_inv__3 imports n_flash_nodata_cub_base
begin
lemma n_PI_Remote_GetVsinv__3:
...
lemma n_PI_Remote_GetXVsinv__3:
...
lemma n_PI_Remote_PutXVsinv__3:
...
lemma n_PI_Remote_ReplaceVsinv__3:
...
lemma n_NI_Local_Get_Nak__part__0Vsinv__3:
...
lemma n_NI_Local_Get_Nak__part__1Vsinv__3:
...
lemma n_NI_Local_Get_Nak__part__2Vsinv__3:
...
lemma n_NI_Local_Get_Get__part__0Vsinv__3:
...
lemma n_NI_Local_Get_Get__part__1Vsinv__3:
...
lemma n_NI_Local_Get_Put_HeadVsinv__3:
...
lemma n_NI_Local_Get_PutVsinv__3:
...
lemma n_NI_Local_Get_Put_DirtyVsinv__3:
...
lemma n_NI_Remote_Get_NakVsinv__3:
...
lemma n_NI_Remote_Get_PutVsinv__3:
...
lemma n_NI_Remote_Get_Put_HomeVsinv__3:
...
lemma n_NI_Local_GetX_Nak__part__0Vsinv__3:
...
lemma n_NI_Local_GetX_Nak__part__1Vsinv__3:
...
lemma n_NI_Local_GetX_Nak__part__2Vsinv__3:
...
lemma n_NI_Local_GetX_GetX__part__0Vsinv__3:
...
lemma n_NI_Local_GetX_GetX__part__1Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_1Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_2Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_3Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_4Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_5Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_6Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_7__part__0Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_7__part__1Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_7_NODE_Get__part__0Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_7_NODE_Get__part__1Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_8_HomeVsinv__3:
...
lemma n_NI_Local_GetX_PutX_8_Home_NODE_GetVsinv__3:
...
lemma n_NI_Local_GetX_PutX_8Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_8_NODE_GetVsinv__3:
...
lemma n_NI_Local_GetX_PutX_9__part__0Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_9__part__1Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_10_HomeVsinv__3:
...
lemma n_NI_Local_GetX_PutX_10Vsinv__3:
...
lemma n_NI_Local_GetX_PutX_11Vsinv__3:
...
moreover {
  assume b1: "(src=p__Inv0)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''Proc'') p__Inv1) ''CacheState'')) (Const CACHE_E)) (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''Local'')) (Const true))))" in exI, auto) done
  then have "invHoldForRule' s f r (invariants N)" by auto
}
moreover {
  assume b1: "(src=p__Inv1)"
...
lemma n_NI_Remote_GetX_NakVsinv__3:
...
lemma n_NI_Remote_GetX_PutXVsinv__3:
...
moreover {
  assume b1: "(src=p__Inv0\<and>dst~=p__Inv0\<and>dst~=p__Inv1)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''Proc'') dst) ''CacheState'')) (Const CACHE_E)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''Proc'') p__Inv1) ''CacheState'')) (Const CACHE_E))))" in exI, auto) done
  then have "invHoldForRule' s f r (invariants N)" by auto
}
moreover {
  assume b1: "(src~=p__Inv0\<and>src~=p__Inv1\<and>dst=p__Inv0)"
...
lemma n_NI_Remote_GetX_PutX_HomeVsinv__3:
...
lemma n_NI_Remote_PutXVsinv__3:
...
moreover {
  assume b1: "(dst=p__Inv1)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv0) ''Cmd'')) (Const UNI_PutX)) (eqn (IVar (Field (Para (Field (Ident ''Sta'') ''UniMsg'') p__Inv1) ''Cmd'')) (Const UNI_PutX))))" in exI, auto) done
  then have "invHoldForRule' s f r (invariants N)" by auto
}
moreover {
  assume b1: "(dst~=p__Inv0\<and>dst~=p__Inv1)"
...
lemma n_PI_Local_GetX_PutX__part__0Vsinv__3:
...
lemma n_PI_Local_GetX_GetX__part__1Vsinv__3:
...
lemma n_PI_Local_GetX_GetX__part__0Vsinv__3:
...
lemma n_PI_Local_ReplaceVsinv__3:
...
lemma n_NI_InvAck_existsVsinv__3:
...
lemma n_PI_Local_Get_PutVsinv__3:
...
lemma n_PI_Local_GetX_PutX_HeadVld__part__0Vsinv__3:
...
lemma n_NI_Remote_GetX_Nak_HomeVsinv__3:
...
lemma n_NI_Local_PutXAcksDoneVsinv__3:
...
lemma n_PI_Local_GetX_PutX__part__1Vsinv__3:
...
lemma n_NI_Remote_Get_Nak_HomeVsinv__3:
...
lemma n_NI_InvAck_exists_HomeVsinv__3:
...
lemma n_NI_Replace_HomeVsinv__3:
...
lemma n_PI_Local_Get_GetVsinv__3:
...
lemma n_PI_Local_GetX_PutX_HeadVld__part__1Vsinv__3:
