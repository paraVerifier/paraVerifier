(*  Title:      HOL/Auth/n_flash_nodata_cub_lemma_on_inv__127.thy
...
theory n_flash_nodata_cub_lemma_on_inv__127 imports n_flash_nodata_cub_base
begin
section{*All lemmas on causal relation between inv__127 and some rule r*}
lemma n_PI_Remote_PutXVsinv__127:
assumes a1: "(\<exists> dst. dst\<le>N\<and>r=n_PI_Remote_PutX  dst)" and
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__127  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain dst where a1:"dst\<le>N\<and>r=n_PI_Remote_PutX  dst" apply fastforce done
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__127  p__Inv4" apply fastforce done
