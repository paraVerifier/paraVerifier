(*  Title:      HOL/Auth/n_flash_lemma_inv__90_on_rules.thy
...
theory n_flash_lemma_inv__90_on_rules imports n_flash_lemma_on_inv__90
begin
section{*All lemmas on causal relation between inv__90*}
lemma lemma_inv__90_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__90  p__Inv4)"
