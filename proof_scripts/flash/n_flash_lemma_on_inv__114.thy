(*  Title:      HOL/Auth/n_flash_lemma_on_inv__114.thy
...
theory n_flash_lemma_on_inv__114 imports n_flash_base
begin
section{*All lemmas on causal relation between inv__114 and some rule r*}
lemma n_NI_Local_Get_Get__part__0Vsinv__114:
assumes a1: "(\<exists> src. src\<le>N\<and>r=n_NI_Local_Get_Get__part__0  src)" and
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__114  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain src where a1:"src\<le>N\<and>r=n_NI_Local_Get_Get__part__0  src" apply fastforce done
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__114  p__Inv4" apply fastforce done
...
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__114  p__Inv4" apply fastforce done
  have "?P3 s"
  apply (cut_tac a1 a2 , simp, rule_tac x="(neg (andForm (andForm (eqn (IVar (Para (Field (Field (Ident ''Sta'') ''Dir'') ''InvSet'') p__Inv4)) (Const true)) (eqn (IVar (Field (Field (Ident ''Sta'') ''Dir'') ''Pending'')) (Const false))) (eqn (IVar (Field (Field (Ident ''Sta'') ''WbMsg'') ''Cmd'')) (Const WB_Wb))))" in exI, auto) done
  then show "invHoldForRule s f r (invariants N)" by auto
qed
