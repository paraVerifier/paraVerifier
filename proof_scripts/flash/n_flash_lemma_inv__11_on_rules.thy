(*  Title:      HOL/Auth/n_flash_lemma_inv__11_on_rules.thy
...
theory n_flash_lemma_inv__11_on_rules imports n_flash_lemma_on_inv__11
begin
...
lemma lemma_inv__11_on_rules:
  ...
  apply (cut_tac b1, auto) done
    ...
    moreover {
      ...
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac b2 d1, metis n_Store_HomeVsinv__11) done
    }
