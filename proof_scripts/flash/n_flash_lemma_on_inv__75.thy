(*  Title:      HOL/Auth/n_flash_lemma_on_inv__75.thy
...
theory n_flash_lemma_on_inv__75 imports n_flash_base
begin
...
a2: "(\<exists> p__Inv4. p__Inv4\<le>N\<and>f=inv__75  p__Inv4)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain src where a1:"src\<le>N\<and>r=n_NI_Local_Get_Put_Head N src" apply fastforce done
from a2 obtain p__Inv4 where a2:"p__Inv4\<le>N\<and>f=inv__75  p__Inv4" apply fastforce done
