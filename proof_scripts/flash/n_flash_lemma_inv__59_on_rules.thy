(*  Title:      HOL/Auth/n_flash_lemma_inv__59_on_rules.thy
...
theory n_flash_lemma_inv__59_on_rules imports n_flash_lemma_on_inv__59
begin
...
lemma lemma_inv__59_on_rules:
  ...
  apply (cut_tac b1, auto) done
    moreover {
      ...
      apply (cut_tac b2 d1, metis n_StoreVsinv__59) done
    }

    moreover {
      assume d1: "(\<exists> data. data\<le>N\<and>r=n_Store_Home  data)"
      have "invHoldForRule s f r (invariants N)"
      apply (cut_tac b2 d1, metis n_Store_HomeVsinv__59) done
    }
