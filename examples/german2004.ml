...
let n_client_generates_new_req_for_addr =
  ...
  let statement = (parallel [(assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "source"]) (param (paramref "client"))); (ifelseStatement (eqn (param (paramref "addr")) (const (intc 0))) (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "dest"]) (const (intc 0))) (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "dest"]) (const (intc 1)))); (ifelseStatement (eqn (param (paramref "req")) (const _req_read_shared)) (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "op"]) (const _read_shared)) (ifelseStatement (eqn (param (paramref "req")) (const _req_read_exclusive)) (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "op"]) (const _read_exclusive)) (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "op"]) (const _req_upgrade)))); (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "msg"; global "addr"]) (param (paramref "addr"))); (assign (record [arr [("node", [paramref "client"])]; arr [("outchan", [paramref "channel1"])]; global "valid"]) (const (boolc true))); (assign (record [arr [("node", [paramref "client"])]; arr [("local_requests", [paramref "addr"])]]) (const (boolc true)))]) in
  rule name params formula statement
...
let n_client_stores_data_in_cache_for_addr =
  ...
  let statement = (parallel [(assign (record [arr [("node", [paramref "client"])]; arr [("cache", [paramref "addr"])]; global "data"; arr [("values", [paramref "data_n"])]]) (param (paramref "data"))); (assign (record [global "auxdata"; arr [("values", [paramref "data_n"])]]) (param (paramref "data")))]) in
  rule name params formula statement
...
let n_data_consistency_property =
  ...
  let formula = (imply (neg (eqn (var (record [arr [("node", [paramref "client"])]; arr [("cache", [paramref "addr"])]; global "state"])) (const _cache_invalid))) (eqn (var (record [arr [("node", [paramref "client"])]; arr [("cache", [paramref "addr"])]; global "data"; arr [("values", [paramref "d"])]])) (var (record [global "auxdata"; arr [("values", [paramref "d"])]])))) in
  prop name params formula
